        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <!-- User Profile-->
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link <?= $this->uri->segment(1) == 'Dashboard' ? 'active' : '' ?>" href="<?= base_url('Dashboard') ?>" aria-expanded="false"><i class="mdi me-2 mdi-gauge"></i><span class="hide-menu">Dashboard</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link <?= $this->uri->segment(1) == 'Formulir' ? 'active' : '' ?>" href="<?= base_url('Formulir') ?>" aria-expanded="false">
                                <i class="fas fa-plus-square"></i><span class="hide-menu">Formulir</span></a>
                        </li>
                            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link " href="<?= base_url('pdf/formulir') ?>" target="_blank" aria-expanded="false">
                                    <i class="fas fa-print"></i><span class="hide-menu">Cetak Formulir</span></a>
                            </li>
