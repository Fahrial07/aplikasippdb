...
class M_data extends CI_Model
{
    ...
    var $column_order = array('user.id_user', 'gelombang.id_gel', 'gelombang.tahun', 'gelombang.gelombang', 'user.status_daftar', 'user.nama', 'user.no_kk', 'user.username', 'user.role_id', 'user.is_active', 'user.tgl_daftar', 'user.tgl_update'); //Sesuaikan dengan field
